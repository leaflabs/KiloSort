...
fpath   = '/home/jkinney/Desktop/eMouse'; % where on disk do you want the simulation? ideally and SSD...
...
pathToYourConfigFile = '/home/jkinney/src/KiloSort/eMouse'; % for this example it's ok to leave this path inside the repo, but for your own config file you *must* put it somewhere else!  
...
% benchmark_simulation(rez2, fullfile(fpath2, 'eMouseGroundTruth.mat'));
% 
% % save python results file for Phy
% rezToPhy(rez2, fpath2);
% 
% %% save and clean up
...
% save(fullfile(fpath2,  'rez2.mat'), 'rez2', '-v7.3');
% 
% % remove temporary file
% delete(ops.fproc);
%

fprintf('Kilosort automerge and save took %2.2f seconds\n', toc)
